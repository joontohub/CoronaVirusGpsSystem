...
class PersonSignIn extends StatefulWidget {
  @override
  _PersonSignInState createState() => _PersonSignInState();
}

class _PersonSignInState extends State<PersonSignIn> {
  // I Think its better to make outh system to login
  // after login then collect their private information.
